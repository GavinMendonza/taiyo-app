    ...
    <>
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content">
          ...
          <label
            htmlFor="my-drawer"
            className="lg:hidden btn btn-primary bg-transparent border-stone-50 border-opacity-50 border-2 mt-4 ml-4 drawer-button"
          >
            {/* <HiOutlineMenuAlt2 /> */}
...
//         <aside
//           id="default-sidebar"
//           className="fixed top-0 left-0 z-40  w-64 h-screen transition-transform -translate-x-full lg:translate-x-0 sm:z-0"
//           aria-label="Sidebar"
//         >
